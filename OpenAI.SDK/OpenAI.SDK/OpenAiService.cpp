...
namespace winrt::OpenAI::implementation
{
    ...
    WF::IAsyncOperation<OpenAI::Image::ImageResponse> OpenAiService::RunRequestAsync(winrt::OpenAI::Image::ImageRequest const& imageRequest)
    {
        ...
        {
            auto json = co_await TryToParseHttpMsgToJsonAsync(response);
    ...
    WF::IAsyncOperation<WDJ::JsonObject> OpenAiService::TryToParseHttpMsgToJsonAsync(WWH::HttpResponseMessage const& msg)
    {
        ...
        try
        {
            ...
            jsonObject = WDJ::JsonObject::Parse(stringResult);
        }
